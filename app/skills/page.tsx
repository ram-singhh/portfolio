...
export const metadata = {
  ...
  description: "Explore the technical web development skills, programming languages, and cloud technologies used by Ram Singh to build fast, responsive websites.",
  alternates: {
    canonical: "/skills/",
  },
};
